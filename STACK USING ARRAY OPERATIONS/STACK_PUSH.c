...
// WE HAVE CREATED THE FUNCTION TO CHECK FOR STACK FLOWS, NOW WE WILL PERFORM PUSH
...
int main(){
    ...
    // Now our stack is full and if we add anything.... it will give us error of STACK OVERFLOW
